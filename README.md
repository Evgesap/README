...
Надеюсь эта небольшая инструкция поможет Вам и мне работать с GIT и в будушем Вы овладеете навыком работы  в _системе контроля версии_ (GIT) и передадите навык следующим кто захочет научится этому.
